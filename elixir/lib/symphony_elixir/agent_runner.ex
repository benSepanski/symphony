defmodule SymphonyElixir.AgentRunner do
  ...
  require Logger
  alias SymphonyElixir.Agent, as: AgentBackend
  ...
  defp run_codex_turns(workspace, issue, codex_update_recipient, opts, worker_host) do
    ...
    with {:ok, session} <- AgentBackend.start_session(workspace, worker_host: worker_host) do
      try do
  ...
  defp do_run_codex_turns(app_session, workspace, issue, codex_update_recipient, opts, issue_state_fetcher, turn_number, max_turns) do
    ...
    with {:ok, turn_result} <-
      ...
      # For Claude Code, the session may be updated with a session_id for --resume
      updated_session = Map.get(turn_result, :session, app_session)
